function [b,fval,exitflag,output] = fzeroq(FunFcnIn,x,options,varargin)
%FZEROQ  Single-variable nonlinear zero finding. 
%Quite implementation of fzero.
...
%   $Revision: 5.33.4.23 $  $Date: 2008/10/31 06:19:59 $
